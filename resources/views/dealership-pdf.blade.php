    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-6">
                ...
                @if($dealer_ship != null && $dealer_ship->dealer_name)
                <h2 class="dealer-name">{{ App\Http\Controllers\DealerController::staticTrans($lang, 'Dealer Name:') }}   {{ $dealer_ship->dealer_name }}</h2>
                @else
                <h2 class="dealer-name">{{ App\Http\Controllers\DealerController::staticTrans($lang, 'Dealer Name: No name found') }}  </h2>
                @endif

                @if($dealer_ship != null && $dealer_ship->dealer_code)
                <h2 class="dealer-name">{{ App\Http\Controllers\DealerController::staticTrans($lang, 'Dealer Account') }}   #: {{ $dealer_ship->dealer_code }}</h2>
                @else
