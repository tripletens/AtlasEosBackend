    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-6">
                ...
                <br>
                <br>
                <h2 class="top-title" style="margin-top: 20px">{{ App\Http\Controllers\DealerController::staticTrans($lang, 'ATLAS 2024 VIRTUAL SHOW') }}   <br> {{ App\Http\Controllers\DealerController::staticTrans($lang, 'PURCHASES BY DEALER (Detailed
                    display)') }} </h2>
