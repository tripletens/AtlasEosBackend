    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-6">
                ...
                <h2 class="top-title">{{ App\Http\Controllers\DealerController::staticTrans($lang, 'ATLAS 2024 VIRTUAL SHOW') }}   <br> {{ App\Http\Controllers\DealerController::staticTrans($lang, 'SUMMARY') }}  <br> {{ App\Http\Controllers\DealerController::staticTrans($lang, 'SUMMARY SALES DISPLAY') }}</h2>
